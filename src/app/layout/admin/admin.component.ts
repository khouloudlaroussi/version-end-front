...
export class AdminComponent implements OnInit {
  ...
  constructor(public menuItems: MenuItems, private modalService: NgbModal, private route: Router, public sharedService: SharedServiceService) {
    this.navType = 'st5';
  ...
  ngOnInit() {
    ...
    this.nomuser = localStorage.getItem("nomuser").toString();
    this.nomuser = this.nomuser.substr(1, this.nomuser.length - 2)
  }
